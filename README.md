...
This is an actual live brief generated by the CLI (Granola × Linear, warm intro via Sequoia — three real attendees across two ICP verticals, each card branded in the company's own colour, ranked by fit, with live signals + citations):

[![Branded pre-meeting brief — Granola × Linear](docs/assets/report-screenshot.png)](https://htmlpreview.github.io/?https://github.com/denose16/granola-meeting-prep/blob/main/samples/output/showcase-live-granola-x-linear.html)

▶ **[Open the rendered brief](https://htmlpreview.github.io/?https://github.com/denose16/granola-meeting-prep/blob/main/samples/output/showcase-live-granola-x-linear.html)** · raw [HTML](samples/output/showcase-live-granola-x-linear.html) · [CSV](samples/output/showcase-live-granola-x-linear.csv) · [Slack payload](samples/output/showcase-live-slack-payload.json) · more in [Sample output](#sample-output).
